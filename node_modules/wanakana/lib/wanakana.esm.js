...
function onCompositionUpdate(event) {
  ...
  var isDoubleConsonant = finalTwoChars.every(function (char) {
    return isCharConsonant(convertFullwidthCharsToASCII(char));
  });
...
export { bind, unbind, isRomaji, isJapanese, isKana, isHiragana, isKatakana, isMixed, isKanji, toRomaji, toKana, toHiragana, toKatakana, stripOkurigana, tokenize };
